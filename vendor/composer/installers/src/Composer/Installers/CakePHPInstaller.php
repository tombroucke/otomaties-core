...
use Otomaties\Core\Composer\DependencyResolver\Pool;
use Otomaties\Core\Composer\Semver\Constraint\Constraint;
class CakePHPInstaller extends BaseInstaller
{
    ...
    public function inflectPackageVars(array $vars): array
    {
        ...
        foreach ($nameParts as &$value) {
            $value = strtolower($this->pregReplace('/(?<=\w)([A-Z])/', 'Otomaties\Core\_\1', $value));

 ...
 */
namespace Otomaties\Core\Symfony\Contracts\Translation\Test;

use Otomaties\Core\PHPUnit\Framework\Attributes\DataProvider;
use Otomaties\Core\PHPUnit\Framework\Attributes\RequiresPhpExtension;
use Otomaties\Core\PHPUnit\Framework\TestCase;
use Otomaties\Core\Symfony\Component\Translation\TranslatableMessage;
use Otomaties\Core\Symfony\Contracts\Translation\TranslatorInterface;
use Otomaties\Core\Symfony\Contracts\Translation\TranslatorTrait;
/**
...
class TranslatorTest extends TestCase
{
    ...
    public static function getChooseTests()
    {
        return [
            ...
            ['There is almost one apple', '{0} There are no apples|]0,1[ There is almost one apple|{1} There is one apple|[1,Inf] There is more than one apple', 0.69999999999999996],

...
use Otomaties\Core\Carbon\Exceptions\EndLessPeriodException;
use Otomaties\Core\Carbon\Exceptions\InvalidCastException;
use Otomaties\Core\Carbon\Exceptions\InvalidIntervalException;
use Otomaties\Core\Carbon\Exceptions\InvalidPeriodDateException;
use Otomaties\Core\Carbon\Exceptions\InvalidPeriodParameterException;
use Otomaties\Core\Carbon\Exceptions\NotACarbonClassException;
use Otomaties\Core\Carbon\Exceptions\NotAPeriodException;
use Otomaties\Core\Carbon\Exceptions\UnknownGetterException;
use Otomaties\Core\Carbon\Exceptions\UnknownMethodException;
use Otomaties\Core\Carbon\Exceptions\UnreachableException;
use Otomaties\Core\Carbon\Traits\DeprecatedPeriodProperties;
...
require \PHP_VERSION < 8.1999999999999993 ? __DIR__ . '/../../lazy/Carbon/ProtectedDatePeriod.php' : __DIR__ . '/../../lazy/Carbon/UnprotectedDatePeriod.php';

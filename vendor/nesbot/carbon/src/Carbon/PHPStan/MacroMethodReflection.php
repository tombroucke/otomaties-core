...
use Otomaties\Core\PHPStan\Reflection\ParametersAcceptor;
use Otomaties\Core\PHPStan\TrinaryLogic;
use Otomaties\Core\PHPStan\Type\Type;
...
class MacroMethodReflection implements MethodReflection
{
    ...
    public function getPrototype(): \Otomaties\Core\PHPStan\Reflection\ClassMemberReflection
    {
        return $this;
    }

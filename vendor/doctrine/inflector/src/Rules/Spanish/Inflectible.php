...
namespace Otomaties\Core\Doctrine\Inflector\Rules\Spanish;
...
class Inflectible
{
    ...
    {
        yield new Transformation(new Pattern('/ú([sn])$/i'), 'Otomaties\Core\u\1es');
        yield new Transformation(new Pattern('/ó([sn])$/i'), 'Otomaties\Core\o\1es');
        yield new Transformation(new Pattern('/í([sn])$/i'), 'Otomaties\Core\i\1es');
        yield new Transformation(new Pattern('/é([sn])$/i'), 'Otomaties\Core\e\1es');
        yield new Transformation(new Pattern('/á([sn])$/i'), 'Otomaties\Core\a\1es');

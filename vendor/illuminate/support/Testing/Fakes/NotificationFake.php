...
namespace Otomaties\Core\Illuminate\Support\Testing\Fakes;

use Closure;
use Exception;
use Otomaties\Core\Illuminate\Contracts\Notifications\Dispatcher as NotificationDispatcher;
use Otomaties\Core\Illuminate\Contracts\Notifications\Factory as NotificationFactory;
use Otomaties\Core\Illuminate\Contracts\Queue\ShouldQueue;
use Otomaties\Core\Illuminate\Contracts\Translation\HasLocalePreference;
use Otomaties\Core\Illuminate\Notifications\AnonymousNotifiable;
...
use Otomaties\Core\Illuminate\Support\Traits\ReflectsClosures;
use Otomaties\Core\PHPUnit\Framework\Assert as PHPUnit;

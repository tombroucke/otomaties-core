...
namespace Otomaties\Core\Illuminate\Container;

use ArrayAccess;
use Closure;
use Exception;
use Otomaties\Core\Illuminate\Container\Attributes\Bind;
use Otomaties\Core\Illuminate\Container\Attributes\Scoped;
use Otomaties\Core\Illuminate\Container\Attributes\Singleton;
use Otomaties\Core\Illuminate\Contracts\Container\BindingResolutionException;
use Otomaties\Core\Illuminate\Contracts\Container\CircularDependencyException;
use Otomaties\Core\Illuminate\Contracts\Container\Container as ContainerContract;
use Otomaties\Core\Illuminate\Contracts\Container\ContextualAttribute;
use Otomaties\Core\Illuminate\Contracts\Container\SelfBuilding;
...
class Container implements ArrayAccess, ContainerContract
{
    ...
    {
        return count($this->with) ? \Otomaties\Core\array_last($this->with) : [];
    }
    /**
    ...
    {
        return \Otomaties\Core\array_last($this->buildStack) ?: null;
    }
    /**

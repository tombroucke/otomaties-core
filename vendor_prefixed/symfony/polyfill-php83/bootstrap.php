...
if (!\function_exists('OtomatiesCoreVendor\\json_validate')) {
    /** @internal */
...
if (!\function_exists('OtomatiesCoreVendor\\stream_context_set_options')) {
    /** @internal */
...
if (!\function_exists('OtomatiesCoreVendor\\str_increment')) {
    /** @internal */
...
if (!\function_exists('OtomatiesCoreVendor\\str_decrement')) {
    /** @internal */
...
if (!\function_exists('OtomatiesCoreVendor\\ldap_exop_sync') && \function_exists('ldap_exop')) {
    /** @internal */
...
if (!\function_exists('OtomatiesCoreVendor\\ldap_connect_wallet') && \function_exists('ldap_connect')) {
    /** @internal */

 ...
 */
namespace OtomatiesCoreVendor\Composer;

use OtomatiesCoreVendor\Composer\Autoload\ClassLoader;
use OtomatiesCoreVendor\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('OtomatiesCoreVendor\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();

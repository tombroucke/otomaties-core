...
use OtomatiesCoreVendor\Composer\Installer\BinaryInstaller;
use OtomatiesCoreVendor\Composer\Installer\LibraryInstaller;
use OtomatiesCoreVendor\Composer\IO\IOInterface;
use OtomatiesCoreVendor\Composer\Package\Package;
